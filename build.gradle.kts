...
// managed-integrity-v1: WHDyE4vwLHk
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-web-mediawiki", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-web-mediawiki")
        description.set("kotlin-web-mediawiki")
        url.set("https://github.com/wabbit-corp/kotlin-web-mediawiki")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-web-mediawiki")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-web-mediawiki.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-web-mediawiki.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-web-mediawiki"
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.web.mediawiki"
        compileSdk = 34
        minSdk = 26
    }
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-web-mediawiki/tree/master/src")
